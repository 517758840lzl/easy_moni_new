...
@JsonKey(name: 'appOrderId', fromJson: _nullableStringFromJson) String? get appOrderId;@JsonKey(name: 'applicationTime') String? get applicationTime;@JsonKey(name: 'productSetCode') String? get productSetCode;@JsonKey(name: 'productLevel', fromJson: _nullableStringFromJson) String? get productLevel;@JsonKey(name: 'orderStatus') int? get orderStatus;@JsonKey(name: 'orderStatusStr') String? get orderStatusStr;@JsonKey(name: 'repayAmount') num? get repayAmount;@JsonKey(name: 'loanAmount') num? get loanAmount;@JsonKey(name: 'receiptAmount') num? get receiptAmount;@JsonKey(name: 'interest') num? get interest;@JsonKey(name: 'overdueInterest') num? get overdueInterest;@JsonKey(name: 'term') int? get term;@JsonKey(name: 'totalServiceDays') int? get totalServiceDays;@JsonKey(name: 'remainingDays') int? get remainingDays;@JsonKey(name: 'productName') String? get productName;@JsonKey(name: 'productLogo') String? get productLogo;@JsonKey(name: 'repayDate') String? get repayDate;@JsonKey(name: 'repayDateStr') String? get repayDateStr;@JsonKey(name: 'repaidAmount') num? get repaidAmount;@JsonKey(name: 'bankCardNo') String? get bankCardNo;@JsonKey(name: 'bankCardName') String? get bankCardName;@JsonKey(name: 'bankCardType', fromJson: _nullableStringFromJson) String? get bankCardType;@JsonKey(name: 'updateTime') String? get updateTime;@JsonKey(name: 'createTime') String? get createTime;@JsonKey(name: 'effectiveTime') String? get effectiveTime;@JsonKey(name: 'acqChannel') String? get acqChannel;@JsonKey(name: 'closeTime') String? get closeTime;@JsonKey(name: 'rejectTime') int? get rejectTime;@JsonKey(name: 'sort') int? get sort;@JsonKey(name: 'isExtensionSwitch') bool? get isExtensionSwitch;@JsonKey(name: 'countdownTime') int? get countdownTime;
...
@useResult
$Res call({
@JsonKey(name: 'appOrderId', fromJson: _nullableStringFromJson) String? appOrderId,@JsonKey(name: 'applicationTime') String? applicationTime,@JsonKey(name: 'productSetCode') String? productSetCode,@JsonKey(name: 'productLevel', fromJson: _nullableStringFromJson) String? productLevel,@JsonKey(name: 'orderStatus') int? orderStatus,@JsonKey(name: 'orderStatusStr') String? orderStatusStr,@JsonKey(name: 'repayAmount') num? repayAmount,@JsonKey(name: 'loanAmount') num? loanAmount,@JsonKey(name: 'receiptAmount') num? receiptAmount,@JsonKey(name: 'interest') num? interest,@JsonKey(name: 'overdueInterest') num? overdueInterest,@JsonKey(name: 'term') int? term,@JsonKey(name: 'totalServiceDays') int? totalServiceDays,@JsonKey(name: 'remainingDays') int? remainingDays,@JsonKey(name: 'productName') String? productName,@JsonKey(name: 'productLogo') String? productLogo,@JsonKey(name: 'repayDate') String? repayDate,@JsonKey(name: 'repayDateStr') String? repayDateStr,@JsonKey(name: 'repaidAmount') num? repaidAmount,@JsonKey(name: 'bankCardNo') String? bankCardNo,@JsonKey(name: 'bankCardName') String? bankCardName,@JsonKey(name: 'bankCardType', fromJson: _nullableStringFromJson) String? bankCardType,@JsonKey(name: 'updateTime') String? updateTime,@JsonKey(name: 'createTime') String? createTime,@JsonKey(name: 'effectiveTime') String? effectiveTime,@JsonKey(name: 'acqChannel') String? acqChannel,@JsonKey(name: 'closeTime') String? closeTime,@JsonKey(name: 'rejectTime') int? rejectTime,@JsonKey(name: 'sort') int? sort,@JsonKey(name: 'isExtensionSwitch') bool? isExtensionSwitch,@JsonKey(name: 'countdownTime') int? countdownTime
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'appOrderId', fromJson: _nullableStringFromJson)  String? appOrderId, @JsonKey(name: 'applicationTime')  String? applicationTime, @JsonKey(name: 'productSetCode')  String? productSetCode, @JsonKey(name: 'productLevel', fromJson: _nullableStringFromJson)  String? productLevel, @JsonKey(name: 'orderStatus')  int? orderStatus, @JsonKey(name: 'orderStatusStr')  String? orderStatusStr, @JsonKey(name: 'repayAmount')  num? repayAmount, @JsonKey(name: 'loanAmount')  num? loanAmount, @JsonKey(name: 'receiptAmount')  num? receiptAmount, @JsonKey(name: 'interest')  num? interest, @JsonKey(name: 'overdueInterest')  num? overdueInterest, @JsonKey(name: 'term')  int? term, @JsonKey(name: 'totalServiceDays')  int? totalServiceDays, @JsonKey(name: 'remainingDays')  int? remainingDays, @JsonKey(name: 'productName')  String? productName, @JsonKey(name: 'productLogo')  String? productLogo, @JsonKey(name: 'repayDate')  String? repayDate, @JsonKey(name: 'repayDateStr')  String? repayDateStr, @JsonKey(name: 'repaidAmount')  num? repaidAmount, @JsonKey(name: 'bankCardNo')  String? bankCardNo, @JsonKey(name: 'bankCardName')  String? bankCardName, @JsonKey(name: 'bankCardType', fromJson: _nullableStringFromJson)  String? bankCardType, @JsonKey(name: 'updateTime')  String? updateTime, @JsonKey(name: 'createTime')  String? createTime, @JsonKey(name: 'effectiveTime')  String? effectiveTime, @JsonKey(name: 'acqChannel')  String? acqChannel, @JsonKey(name: 'closeTime')  String? closeTime, @JsonKey(name: 'rejectTime')  int? rejectTime, @JsonKey(name: 'sort')  int? sort, @JsonKey(name: 'isExtensionSwitch')  bool? isExtensionSwitch, @JsonKey(name: 'countdownTime')  int? countdownTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderListItem() when $default != null:
return $default(_that.appOrderId,_that.applicationTime,_that.productSetCode,_that.productLevel,_that.orderStatus,_that.orderStatusStr,_that.repayAmount,_that.loanAmount,_that.receiptAmount,_that.interest,_that.overdueInterest,_that.term,_that.totalServiceDays,_that.remainingDays,_that.productName,_that.productLogo,_that.repayDate,_that.repayDateStr,_that.repaidAmount,_that.bankCardNo,_that.bankCardName,_that.bankCardType,_that.updateTime,_that.createTime,_that.effectiveTime,_that.acqChannel,_that.closeTime,_that.rejectTime,_that.sort,_that.isExtensionSwitch,_that.countdownTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'appOrderId', fromJson: _nullableStringFromJson)  String? appOrderId, @JsonKey(name: 'applicationTime')  String? applicationTime, @JsonKey(name: 'productSetCode')  String? productSetCode, @JsonKey(name: 'productLevel', fromJson: _nullableStringFromJson)  String? productLevel, @JsonKey(name: 'orderStatus')  int? orderStatus, @JsonKey(name: 'orderStatusStr')  String? orderStatusStr, @JsonKey(name: 'repayAmount')  num? repayAmount, @JsonKey(name: 'loanAmount')  num? loanAmount, @JsonKey(name: 'receiptAmount')  num? receiptAmount, @JsonKey(name: 'interest')  num? interest, @JsonKey(name: 'overdueInterest')  num? overdueInterest, @JsonKey(name: 'term')  int? term, @JsonKey(name: 'totalServiceDays')  int? totalServiceDays, @JsonKey(name: 'remainingDays')  int? remainingDays, @JsonKey(name: 'productName')  String? productName, @JsonKey(name: 'productLogo')  String? productLogo, @JsonKey(name: 'repayDate')  String? repayDate, @JsonKey(name: 'repayDateStr')  String? repayDateStr, @JsonKey(name: 'repaidAmount')  num? repaidAmount, @JsonKey(name: 'bankCardNo')  String? bankCardNo, @JsonKey(name: 'bankCardName')  String? bankCardName, @JsonKey(name: 'bankCardType', fromJson: _nullableStringFromJson)  String? bankCardType, @JsonKey(name: 'updateTime')  String? updateTime, @JsonKey(name: 'createTime')  String? createTime, @JsonKey(name: 'effectiveTime')  String? effectiveTime, @JsonKey(name: 'acqChannel')  String? acqChannel, @JsonKey(name: 'closeTime')  String? closeTime, @JsonKey(name: 'rejectTime')  int? rejectTime, @JsonKey(name: 'sort')  int? sort, @JsonKey(name: 'isExtensionSwitch')  bool? isExtensionSwitch, @JsonKey(name: 'countdownTime')  int? countdownTime)  $default,) {final _that = this;
switch (_that) {
case _OrderListItem():
return $default(_that.appOrderId,_that.applicationTime,_that.productSetCode,_that.productLevel,_that.orderStatus,_that.orderStatusStr,_that.repayAmount,_that.loanAmount,_that.receiptAmount,_that.interest,_that.overdueInterest,_that.term,_that.totalServiceDays,_that.remainingDays,_that.productName,_that.productLogo,_that.repayDate,_that.repayDateStr,_that.repaidAmount,_that.bankCardNo,_that.bankCardName,_that.bankCardType,_that.updateTime,_that.createTime,_that.effectiveTime,_that.acqChannel,_that.closeTime,_that.rejectTime,_that.sort,_that.isExtensionSwitch,_that.countdownTime);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'appOrderId', fromJson: _nullableStringFromJson)  String? appOrderId, @JsonKey(name: 'applicationTime')  String? applicationTime, @JsonKey(name: 'productSetCode')  String? productSetCode, @JsonKey(name: 'productLevel', fromJson: _nullableStringFromJson)  String? productLevel, @JsonKey(name: 'orderStatus')  int? orderStatus, @JsonKey(name: 'orderStatusStr')  String? orderStatusStr, @JsonKey(name: 'repayAmount')  num? repayAmount, @JsonKey(name: 'loanAmount')  num? loanAmount, @JsonKey(name: 'receiptAmount')  num? receiptAmount, @JsonKey(name: 'interest')  num? interest, @JsonKey(name: 'overdueInterest')  num? overdueInterest, @JsonKey(name: 'term')  int? term, @JsonKey(name: 'totalServiceDays')  int? totalServiceDays, @JsonKey(name: 'remainingDays')  int? remainingDays, @JsonKey(name: 'productName')  String? productName, @JsonKey(name: 'productLogo')  String? productLogo, @JsonKey(name: 'repayDate')  String? repayDate, @JsonKey(name: 'repayDateStr')  String? repayDateStr, @JsonKey(name: 'repaidAmount')  num? repaidAmount, @JsonKey(name: 'bankCardNo')  String? bankCardNo, @JsonKey(name: 'bankCardName')  String? bankCardName, @JsonKey(name: 'bankCardType', fromJson: _nullableStringFromJson)  String? bankCardType, @JsonKey(name: 'updateTime')  String? updateTime, @JsonKey(name: 'createTime')  String? createTime, @JsonKey(name: 'effectiveTime')  String? effectiveTime, @JsonKey(name: 'acqChannel')  String? acqChannel, @JsonKey(name: 'closeTime')  String? closeTime, @JsonKey(name: 'rejectTime')  int? rejectTime, @JsonKey(name: 'sort')  int? sort, @JsonKey(name: 'isExtensionSwitch')  bool? isExtensionSwitch, @JsonKey(name: 'countdownTime')  int? countdownTime)?  $default,) {final _that = this;
switch (_that) {
case _OrderListItem() when $default != null:
return $default(_that.appOrderId,_that.applicationTime,_that.productSetCode,_that.productLevel,_that.orderStatus,_that.orderStatusStr,_that.repayAmount,_that.loanAmount,_that.receiptAmount,_that.interest,_that.overdueInterest,_that.term,_that.totalServiceDays,_that.remainingDays,_that.productName,_that.productLogo,_that.repayDate,_that.repayDateStr,_that.repaidAmount,_that.bankCardNo,_that.bankCardName,_that.bankCardType,_that.updateTime,_that.createTime,_that.effectiveTime,_that.acqChannel,_that.closeTime,_that.rejectTime,_that.sort,_that.isExtensionSwitch,_that.countdownTime);case _:
  return null;
...
class _OrderListItem implements OrderListItem {
  const _OrderListItem({@JsonKey(name: 'appOrderId', fromJson: _nullableStringFromJson) this.appOrderId, @JsonKey(name: 'applicationTime') this.applicationTime, @JsonKey(name: 'productSetCode') this.productSetCode, @JsonKey(name: 'productLevel', fromJson: _nullableStringFromJson) this.productLevel, @JsonKey(name: 'orderStatus') this.orderStatus, @JsonKey(name: 'orderStatusStr') this.orderStatusStr, @JsonKey(name: 'repayAmount') this.repayAmount, @JsonKey(name: 'loanAmount') this.loanAmount, @JsonKey(name: 'receiptAmount') this.receiptAmount, @JsonKey(name: 'interest') this.interest, @JsonKey(name: 'overdueInterest') this.overdueInterest, @JsonKey(name: 'term') this.term, @JsonKey(name: 'totalServiceDays') this.totalServiceDays, @JsonKey(name: 'remainingDays') this.remainingDays, @JsonKey(name: 'productName') this.productName, @JsonKey(name: 'productLogo') this.productLogo, @JsonKey(name: 'repayDate') this.repayDate, @JsonKey(name: 'repayDateStr') this.repayDateStr, @JsonKey(name: 'repaidAmount') this.repaidAmount, @JsonKey(name: 'bankCardNo') this.bankCardNo, @JsonKey(name: 'bankCardName') this.bankCardName, @JsonKey(name: 'bankCardType', fromJson: _nullableStringFromJson) this.bankCardType, @JsonKey(name: 'updateTime') this.updateTime, @JsonKey(name: 'createTime') this.createTime, @JsonKey(name: 'effectiveTime') this.effectiveTime, @JsonKey(name: 'acqChannel') this.acqChannel, @JsonKey(name: 'closeTime') this.closeTime, @JsonKey(name: 'rejectTime') this.rejectTime, @JsonKey(name: 'sort') this.sort, @JsonKey(name: 'isExtensionSwitch') this.isExtensionSwitch, @JsonKey(name: 'countdownTime') this.countdownTime});
  factory _OrderListItem.fromJson(Map<String, dynamic> json) => _$OrderListItemFromJson(json);

@override@JsonKey(name: 'appOrderId', fromJson: _nullableStringFromJson) final  String? appOrderId;
@override@JsonKey(name: 'applicationTime') final  String? applicationTime;
@override@JsonKey(name: 'productSetCode') final  String? productSetCode;
@override@JsonKey(name: 'productLevel', fromJson: _nullableStringFromJson) final  String? productLevel;
...
@override@JsonKey(name: 'bankCardType', fromJson: _nullableStringFromJson) final  String? bankCardType;
...
/// Create a copy of OrderListItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? appOrderId = freezed,Object? applicationTime = freezed,Object? productSetCode = freezed,Object? productLevel = freezed,Object? orderStatus = freezed,Object? orderStatusStr = freezed,Object? repayAmount = freezed,Object? loanAmount = freezed,Object? receiptAmount = freezed,Object? interest = freezed,Object? overdueInterest = freezed,Object? term = freezed,Object? totalServiceDays = freezed,Object? remainingDays = freezed,Object? productName = freezed,Object? productLogo = freezed,Object? repayDate = freezed,Object? repayDateStr = freezed,Object? repaidAmount = freezed,Object? bankCardNo = freezed,Object? bankCardName = freezed,Object? bankCardType = freezed,Object? updateTime = freezed,Object? createTime = freezed,Object? effectiveTime = freezed,Object? acqChannel = freezed,Object? closeTime = freezed,Object? rejectTime = freezed,Object? sort = freezed,Object? isExtensionSwitch = freezed,Object? countdownTime = freezed,}) {
