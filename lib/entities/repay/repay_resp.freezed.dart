...
@JsonKey(name: 'acqChannel') String? get acqChannel;@JsonKey(name: 'appOrderId') String? get appOrderId;@JsonKey(name: 'applicationTime') String? get applicationTime;@JsonKey(name: 'bankCardName') String? get bankCardName;@JsonKey(name: 'bankCardNo') String? get bankCardNo;@JsonKey(name: 'bankCardType') String? get bankCardType;@JsonKey(name: 'closeTime') int? get closeTime;@JsonKey(name: 'countdownTime') int? get countdownTime;@JsonKey(name: 'createTime') String? get createTime;@JsonKey(name: 'effectiveTime') String? get effectiveTime;@JsonKey(name: 'interest') num? get interest;@JsonKey(name: 'isExtensionSwitch') bool? get isExtensionSwitch;@JsonKey(name: 'loanAmount') num? get loanAmount;@JsonKey(name: 'orderStatus') int? get orderStatus;@JsonKey(name: 'orderStatusStr') String? get orderStatusStr;@JsonKey(name: 'overdueInterest') num? get overdueInterest;@JsonKey(name: 'productLevel') int? get productLevel;@JsonKey(name: 'productLogo') String? get productLogo;@JsonKey(name: 'productName') String? get productName;@JsonKey(name: 'productSetCode') String? get productSetCode;@JsonKey(name: 'receiptAmount') num? get receiptAmount;@JsonKey(name: 'rejectTime') int? get rejectTime;@JsonKey(name: 'remainingDays') int? get remainingDays;@JsonKey(name: 'repaidAmount') num? get repaidAmount;@JsonKey(name: 'repayAmount') num? get repayAmount;@JsonKey(name: 'repayDate') String? get repayDate;@JsonKey(name: 'repayDateStr') String? get repayDateStr;@JsonKey(name: 'sort') int? get sort;@JsonKey(name: 'term') int? get term;@JsonKey(name: 'totalServiceDays') int? get totalServiceDays;@JsonKey(name: 'updateTime') String? get updateTime;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,acqChannel,appOrderId,applicationTime,bankCardName,bankCardNo,bankCardType,closeTime,countdownTime,createTime,effectiveTime,interest,isExtensionSwitch,loanAmount,orderStatus,orderStatusStr,overdueInterest,productLevel,productLogo,productName,productSetCode,receiptAmount,rejectTime,remainingDays,repaidAmount,repayAmount,repayDate,repayDateStr,sort,term,totalServiceDays,updateTime]);

@override
String toString() {
  return 'RepayResp(acqChannel: $acqChannel, appOrderId: $appOrderId, applicationTime: $applicationTime, bankCardName: $bankCardName, bankCardNo: $bankCardNo, bankCardType: $bankCardType, closeTime: $closeTime, countdownTime: $countdownTime, createTime: $createTime, effectiveTime: $effectiveTime, interest: $interest, isExtensionSwitch: $isExtensionSwitch, loanAmount: $loanAmount, orderStatus: $orderStatus, orderStatusStr: $orderStatusStr, overdueInterest: $overdueInterest, productLevel: $productLevel, productLogo: $productLogo, productName: $productName, productSetCode: $productSetCode, receiptAmount: $receiptAmount, rejectTime: $rejectTime, remainingDays: $remainingDays, repaidAmount: $repaidAmount, repayAmount: $repayAmount, repayDate: $repayDate, repayDateStr: $repayDateStr, sort: $sort, term: $term, totalServiceDays: $totalServiceDays, updateTime: $updateTime)';
}
...
/// Create a copy of RepayResp
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? acqChannel = freezed,Object? appOrderId = freezed,Object? applicationTime = freezed,Object? bankCardName = freezed,Object? bankCardNo = freezed,Object? bankCardType = freezed,Object? closeTime = freezed,Object? countdownTime = freezed,Object? createTime = freezed,Object? effectiveTime = freezed,Object? interest = freezed,Object? isExtensionSwitch = freezed,Object? loanAmount = freezed,Object? orderStatus = freezed,Object? orderStatusStr = freezed,Object? overdueInterest = freezed,Object? productLevel = freezed,Object? productLogo = freezed,Object? productName = freezed,Object? productSetCode = freezed,Object? receiptAmount = freezed,Object? rejectTime = freezed,Object? remainingDays = freezed,Object? repaidAmount = freezed,Object? repayAmount = freezed,Object? repayDate = freezed,Object? repayDateStr = freezed,Object? sort = freezed,Object? term = freezed,Object? totalServiceDays = freezed,Object? updateTime = freezed,}) {
...
switch (_that) {
case _RepayResp() when $default != null:
return $default(_that.acqChannel,_that.appOrderId,_that.applicationTime,_that.bankCardName,_that.bankCardNo,_that.bankCardType,_that.closeTime,_that.countdownTime,_that.createTime,_that.effectiveTime,_that.interest,_that.isExtensionSwitch,_that.loanAmount,_that.orderStatus,_that.orderStatusStr,_that.overdueInterest,_that.productLevel,_that.productLogo,_that.productName,_that.productSetCode,_that.receiptAmount,_that.rejectTime,_that.remainingDays,_that.repaidAmount,_that.repayAmount,_that.repayDate,_that.repayDateStr,_that.sort,_that.term,_that.totalServiceDays,_that.updateTime);case _:
  return orElse();
...
class _RepayResp implements RepayResp {
  const _RepayResp({@JsonKey(name: 'acqChannel') this.acqChannel, @JsonKey(name: 'appOrderId') this.appOrderId, @JsonKey(name: 'applicationTime') this.applicationTime, @JsonKey(name: 'bankCardName') this.bankCardName, @JsonKey(name: 'bankCardNo') this.bankCardNo, @JsonKey(name: 'bankCardType') this.bankCardType, @JsonKey(name: 'closeTime') this.closeTime, @JsonKey(name: 'countdownTime') this.countdownTime, @JsonKey(name: 'createTime') this.createTime, @JsonKey(name: 'effectiveTime') this.effectiveTime, @JsonKey(name: 'interest') this.interest, @JsonKey(name: 'isExtensionSwitch') this.isExtensionSwitch, @JsonKey(name: 'loanAmount') this.loanAmount, @JsonKey(name: 'orderStatus') this.orderStatus, @JsonKey(name: 'orderStatusStr') this.orderStatusStr, @JsonKey(name: 'overdueInterest') this.overdueInterest, @JsonKey(name: 'productLevel') this.productLevel, @JsonKey(name: 'productLogo') this.productLogo, @JsonKey(name: 'productName') this.productName, @JsonKey(name: 'productSetCode') this.productSetCode, @JsonKey(name: 'receiptAmount') this.receiptAmount, @JsonKey(name: 'rejectTime') this.rejectTime, @JsonKey(name: 'remainingDays') this.remainingDays, @JsonKey(name: 'repaidAmount') this.repaidAmount, @JsonKey(name: 'repayAmount') this.repayAmount, @JsonKey(name: 'repayDate') this.repayDate, @JsonKey(name: 'repayDateStr') this.repayDateStr, @JsonKey(name: 'sort') this.sort, @JsonKey(name: 'term') this.term, @JsonKey(name: 'totalServiceDays') this.totalServiceDays, @JsonKey(name: 'updateTime') this.updateTime});
